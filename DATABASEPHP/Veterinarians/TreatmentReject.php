<?php
	...
	mysqli_close($con);
	$con = mysqli_connect("dijkstra.ug.bcc.bilkent.edu.tr","mert.duran","mkyRf3AL","mert_duran");
	$query = "UPDATE Request_Treatment SET acc_status = 'rejected' WHERE animal_id = '$animal_id' && keeper_user_id = '$keeper_user_id' && vet_user_id = '$userID' && date_time = '$date_time'";
	$result = mysqli_query($con, $query);
	mysqli_close($con);
